...
# 🗺️ モカピー世界における種族の分類（Insect vs Fairy）

モカピーが出会うサブキャラクターたちは、大きく分けて「虫（インセクト）」と「妖精（フェアリー）」の2つの種族に分類されます。彼らは見た目のガジェットだけでなく、その生命のルーツや生態が根本から異なります。

### 🐛 虫（インセクト）種族
- **該当キャラ：** レドビー、ダンゴロロン など
- **特徴：** 生物としての本能やリアルな虫の生態をベースに、独自の進化や乗り物を手に入れた者たち。現実の自然やガジェットとダイレクトにリンクした、親しみやすくもどこか野生を感じる生命体。

### 🧚 妖精（フェアリー）種族
- **該当キャラ：** カプッチ、シュガー・シュガロ など
- **特徴：** 人間のカルチャー（カフェ、お菓子、身の回りのアイテム）から生まれた概念的な生命体。不思議なスーツやカプセルに身を包み、現実の物理法則（飛行など）を無視した独自の超常能力（リニア移動など）を持つ神秘的な存在。
